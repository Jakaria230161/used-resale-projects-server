...
const uri = "mongodb+srv://mobileSellerReviewUserDb:IdNkDmgyqFTOPhHq@cluster0.wjzfsxz.mongodb.net/?retryWrites=true&w=majority";
const client = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true, serverApi: ServerApiVersion.v1 });
...
async function run() {
    try {
        const usersCollection = client.db("mobileSellerBuyer").collection("users");
        const categoriesCollection = client.db("mobileSellerBuyer").collection("categories");
        const productsCollection = client.db("mobileSellerBuyer").collection("products");
        const bookingsCollection = client.db("mobileSellerBuyer").collection("bookings");
        const wishlistsCollection = client.db("mobileSellerBuyer").collection("wishlists");
        const paymentsCollection = client.db("mobileSellerBuyer").collection("payments");
